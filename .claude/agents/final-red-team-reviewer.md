...
최종 요청 시 현재 문항 전체와 인용된 경험 정본을 함께 검수한다. 수정 문항의 사실뿐 아니라 다른 문항과 역할·기간·수치가 충돌하지 않는지도 확인한다. PASS는 실제 검수한 파일 해시에만 적용되며 과거 초안/다른 본문을 승인하지 않는다. 공식 공고의 최신 상태·자격·문항 확인 기록을 보고 미확인이 있으면 해당 항목을 지적한다.
